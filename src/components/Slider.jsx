            ...
            <div className="flex flex-col justify-center h-min gap-3 w-full ">
                ...
                <div className="grid grid-cols-2 h-full w-full gap-3 ">
                    ...
                    <div className="flex flex-col gap-3 h-full">
                        <section className="flex flex-col gap-3 px-2 py-4 sm:p-4 w-full h-full bg-gradient-to-br from-red-500/80 to-orange-400/80 rounded-3xl  shadow-[2px_5px_30px_-20px] shadow-neutral-700">
                        ...
                        <section className="hidden h-full sm:flex flex-col gap-3 p-4 w-full  text-white bg-gradient-to-br from-orange-400/80 to-red-400/60 rounded-3xl shadow-[2px_5px_30px_-20px] shadow-neutral-700 transition-all duration-300 ease-in-out">

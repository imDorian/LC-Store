...
const Slider = () => {
    ...
    return (
        <div id="home" className="w-full min-h-dvh relative ">
            ...
            <div className="absolute top-0 left-0 w-full h-full  flex flex-col items-center justify-start p-5 pt-[60px] gap-5">
                ...
                <a href="#shop" className="absolute bottom-5 flex rounded-full size-18 bg-gradient-to-b from-amber-300 to-amber-500 items-center justify-center shadow-2xl shadow-neutral-700  text-base font-medium animate-bounce italic text-neutral-800">Tienda</a>
            </div>
        </div>
    )
}

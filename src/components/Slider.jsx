    ...
    return (
        <div id="home" className="w-full h-screen relative bg-[url('/road.png')] bg-center filter brightness-75 contrast-125 saturate-125">
            ...
            <div className="absolute top-0 left-0 w-full h-full bg-black/10 flex flex-col items-center justify-center p-5 pt-[50px] gap-5">
                ...
                <a href="#shop" className="mt-10 rounded-full size-18 bg-gradient-to-b from-amber-300 to-amber-500 flex items-center justify-center shadow-2xl shadow-neutral-700  text-base font-medium animate-bounce">Tienda</a>
            </div>
        </div>
    )
}

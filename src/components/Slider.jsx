            ...
            <div className=" flex flex-col items-center justify-center p-5 pt-[60px] gap-5 ">
                ...
                <div className="grid grid-cols-2 w-full gap-3">
                    ...
                    <div className="grid grid-cols-1 grid-rows-2 gap-3">
                        <section className="flex flex-col gap-3 p-4 w-full bg-gradient-to-br from-red-500/80 to-orange-400/80 rounded-3xl h-full shadow-[2px_5px_30px_-20px] shadow-neutral-700">
                            ...
                            <button className="w-full bg-neutral-600/80 rounded-lg py-0.5 text-white hover:bg-neutral-700 transition-all duration-300 hover:scale-102">Buscar producto</button>
                        </section>
                        <section className="flex flex-col gap-3 p-4 w-full text-white bg-gradient-to-br from-orange-400/80 to-red-400/60 rounded-3xl h-min shadow-[2px_5px_30px_-20px] shadow-neutral-700 transition-all duration-300 ease-in-out">
